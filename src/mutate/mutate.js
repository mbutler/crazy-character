...
const otherAnimals = [
    ...
    { range: [4], name: "Aphid" },
    { range: [53, 54], name: "Ladybird " },
    { range: [5], name: "Bark beetle  beetle" },
    { range: [55], name: "Leafhopper " },
    { range: [6, 7], name: "Bee " },
    { range: [56], name: "Louse" },
    ...
    { range: [29], name: "Dung beetle  beetle" },
    ...
    { range: [38], name: "Fly" },
    { range: [90], name: "Thorn bug " },
    { range: [39], name: "Froghopper " },
    { range: [91], name: "Tick" },
    { range: [40], name: "Fruitfly" },
    { range: [92], name: "Velvet worm" },
    { range: [41, 42], name: "Grasshopper " },
    { range: [93], name: "Waxworm  moth" },
    { range: [43], name: "Grub " },
    { range: [94], name: "Weevil" },
    { range: [44, 45], name: "Hornet " },
    { range: [95, 96], name: "Weta" },
    { range: [46], name: "Hoverfly" },
    { range: [97], name: "Whip scorpion" },
    { range: [47, 48], name: "Jewel beetle  bug" },
...
const mammals = [
    ...
    { range: [37], name: "Goat" },
    { range: [78], name: "Sabretooth tiger " },
    { range: [38], name: "Gopher" },
    { range: [79], name: "Sheep" },
    { range: [39], name: "Guinea pig " },
    { range: [80], name: "Skunk" },
    { range: [40], name: "Hare " },
    { range: [81], name: "Sloth" },
    { range: [41], name: "Hedgehog " },
...
const plants = [
    { range: [1], name: "Acacia" },
    { range: [40], name: "Corn/Maize " },
    { range: [2], name: "Acanthus  willow" },
    { range: [41], name: "Cotton " },
    { range: [3], name: "Aloe" },
    { range: [42], name: "Cypress, juniper, " },
    { range: [4], name: "Anise, fennel, " },
    { range: [43], name: "Dahlia, daisy " },
    { range: [5], name: "Apple tree" },
    { range: [44], name: "Damiana  flower" },
    { range: [6], name: "Asparagus" },
    { range: [45], name: "Dancing grass " },
    { range: [7], name: "Ayahuasca " },
    { range: [46], name: "Dandelion" },
    { range: [8], name: "Azalea " },
    { range: [47], name: "Dogbane" },
    { range: [9], name: "Bamboo" },
    { range: [48], name: "Dream herb  of God" },
    { range: [10], name: "Baobab  blood tree" },
    { range: [49], name: "Ebony  tree" },
    { range: [11], name: "Barley " },
    { range: [50], name: "Eggplant  vine" },
    { range: [12], name: "Basil " },
    { range: [51], name: "Flowering plant" },
    { range: [13], name: "Bean, legume, " },
    { range: [52], name: "Flypaper trap " },
    { range: [14], name: "Berry  plant" },
    { range: [53], name: "Foxtail" },
    { range: [15], name: "Birch, holly, " },
    { range: [54], name: "Cucumber " },
    { range: [16], name: "Bladderwort" },
    { range: [55], name: "Fungus" },
    { range: [17], name: "Blackthorn " },
    { range: [56], name: "Garlic " },
    { range: [18], name: "Boxthorn " },
    { range: [57], name: "Goosefoot" },
    { range: [19], name: "Bramble " },
    { range: [58], name: "Gourd, melon, " },
    { range: [20], name: "Broccoli " },
    { range: [59], name: "Grape vine" },
    { range: [21], name: "Bush  " },
    { range: [60], name: "Grass, herb, " },
    { range: [22], name: "Cabbage " },
    ...
    { range: [25], name: "Cane " },
    { range: [64], name: "Kava" },
    { range: [26], name: "Cannabis " },
    { range: [65], name: "Kelp " },
    { range: [27], name: "Carpet weed  plant" },
    { range: [66], name: "Khat " },
    { range: [28], name: "Carrion flower" },
    { range: [67], name: "Knotweed " },
    { range: [29], name: "Carrot, parsnip, radish, " },
    { range: [68], name: "Laurel" },
    { range: [30], name: "Cedar  tree" },
    { range: [69], name: "Lavender, mint, " },
    { range: [31], name: "Celery, cilantro, " },
    { range: [70], name: "Lily" },
    { range: [32], name: "Chestnut, lychee,  tree" },
    { range: [71], name: "Lotus " },
    { range: [33], name: "Cholla " },
    { range: [72], name: "Magnolia " },
    { range: [34], name: "Cinchona" },
    { range: [73], name: "Mandrake" },
    { range: [35], name: "Citrus tree" },
    { range: [74], name: "Mold" },
    { range: [36], name: "Climbing plant " },
    { range: [75], name: "Monkey, puzzle tree" },
    { range: [37], name: "Coffee shrub " },
    { range: [76], name: "Morning glory" },
    { range: [38], name: "Conifer " },
    { range: [77], name: "Moss" },
    { range: [39], name: "Coralillo  bean" },
    { range: [78], name: "Mushroom " },
    { range: [79], name: "Nettle " },
    { range: [90], name: "Pumpkin" },
    { range: [80], name: "Nutmeg tree" },
    { range: [91], name: "Rice" },
    { range: [81], name: "Oat, rye, " },
    { range: [92], name: "Root vegetable " },
    { range: [82], name: "Olive tree" },
    { range: [93], name: "Rubber tree" },
    { range: [83], name: "Onyanga  of Jericho" },
...
const aquatic = [
    ...
    { range: [12], name: "Carp" },
    { range: [41], name: "Kiwa  crab" },
    { range: [13], name: "Catfish" },
    { range: [42], name: "Koi" },
    { range: [14], name: "Clam, mussel, " },
    ...
    { range: [18], name: "Coral" },
    { range: [47], name: "Lungfish  catfish" },
    { range: [19, 20], name: "Crab" },
    { range: [48], name: "Marine dinosaur" },
    { range: [21, 22], name: "Crayfish " },
...
const birds = [
    ...
    { range: [88], name: "Stork" },
    { range: [64], name: "Pelican " },
    { range: [89], name: "Swallow" },
    { range: [65, 66], name: "Penguin" },
    { range: [90], name: "Swan" },
    { range: [67, 68], name: "Pheasant " },
...
const fantasticAnimals = [
    ...
    { range: [21], name: "Dahu  haggis" },
    { range: [51], name: "Hippogriff" },
    { range: [22], name: "Direwolf" },
    { range: [52], name: "Hoop snake " },
    ...
    {
        range: [82],
        name: "A " + pick(mammals) + " mixed with a " + pick(birds),
    },
    ...
    { range: [87], name: "Skvader " },
    { range: [67], name: "Lamassu " },
...
const fantasticPeoples = [
    ...
    { range: [37], name: "Golem" },
    { range: [16], name: "Dryad " },
    { range: [38, 39], name: "Gorgon " },
    { range: [17, 18], name: "Dwarf" },
    { range: [40], name: "Green man" },
    { range: [19], name: "Elder thing  race" },
    { range: [41], name: "Hag " },
...
const bodyFunctions = [
    ...
    { range: [313], name: "No Sense of Smell " },
...
const alternateLocomotion = [
    ...
    { range: [11], name: "Mass of tendrils " },
...
const anthropomorphicAppearance = [
    {
        range: [1, 2, 3],
        name: "Body is half-human, facial features are all creatures.",
    },
...
const claws = [
    { range: [1], name: "Crab-like claws f" },
...
const horns = [
    ...
    { range: [9, 10], name: "Three  large horns" },
    { range: [3, 4], name: "One small horn" },
    { range: [11], name: "Three  small horns" },
...
const weapon = [
    { range: [1], name: "Club (blunt, jagged, )" },
    { range: [4], name: "Spear  weapon." },
    { range: [2], name: "Flail, lash, " },
    { range: [5], name: "Explosive weapon" },
    { range: [3], name: "Knife , like blades" },
...
const mane = [
    ...
    { range: [7], name: "Mane of barbs, quills, " },
...
const earlessness = [
    ...
    { range: [3], name: "No ears whatsoever, internal ." },
...
const pattern = [
    ...
    { range: [6, 8], name: "Different colour face " },
...
const texture = [
    { range: [1], name: "Bark  material" },
    { range: [7], name: "Hard  plastic" },
    { range: [2], name: "Brick, dirt, " },
    { range: [8], name: "Metal" },
...
const tentacles = [
    ...
    { range: [7], name: "Tentacles on head " },
...
/// BODY FUNCTIONS ///
const allergies = [
    { range: [1], name: "A specific food type." },
    { range: [11], name: "Most drugs." },
    { range: [2, 3], name: "Animal fur." },
    { range: [12], name: "Natural fabrics." },
    { range: [4], name: "Dust." },
    { range: [13], name: "Nuts." },
    { range: [5], name: "Feathers." },
    { range: [14], name: "Paint and/." },
    { range: [6], name: "Fruits." },
    { range: [15], name: "Perfume." },
    { range: [7], name: "Insects." },
    { range: [16], name: "Petroleum products." },
    { range: [8], name: "Iron ." },
    { range: [17], name: "Plastics." },
    { range: [9], name: "Latex." },
    { range: [18, 19], name: "Pollen." },
    { range: [10], name: "Leather." },
    { range: [20], name: "Synthetic fabrics." },
]

const bioluminescence = [
    { range: [1], name: "Arousal/excitement." },
    { range: [4, 5], name: "Glows in the dark." },
    { range: [2, 3], name: "At will." },
    { range: [6], name: "Stress, induced." },
]

const bloodSubstitution = [
    { range: [1], name: "Amoeba " },
    { range: [11], name: "Lava  metal" },
    { range: [2], name: "Hemolymph fluid" },
    { range: [12], name: "Leeches " },
    { range: [3], name: "Respiratory proteins" },
    { range: [13], name: "Mercury" },
    { range: [4], name: "Acid" },
    { range: [14], name: "Noxious gas" },
    { range: [5], name: "Ichor" },
    { range: [15], name: "Powder " },
    { range: [6], name: "Poisonous venom" },
    { range: [16], name: "Spirits" },
    { range: [7], name: "Black bile" },
    { range: [17], name: "Urine" },
    { range: [8], name: "Electricity" },
    { range: [18], name: "Vomit" },
    { range: [9], name: "Fire" },
    { range: [19], name: "Water" },
    { range: [10], name: "Gasoline" },
    { range: [20], name: "Wine" },
]

const colourBlind = [
    { range: [1, 2], name: "Dichromacy (green and red look the same)." },
    { range: [3], name: "Monochromacy (mutant sees in black and white)." },
    {
        range: [4],
        name: "Tritanopia (blue and green look the same; violet and yellow look the same).",
    },
]

const decreasedCapability = [
    { range: [1, 2], name: "Agility, dexterity, and/" },
    { range: [3], name: "Balance, co, ordination, and/" },
    { range: [4, 5], name: "Health, stamina, and/" },
    { range: [6], name: "Movement speed" },
    { range: [7, 8], name: "Strength" },
]

const mutationTableIndex = [
    { name: "Body: Form", range: _.range(1, 201), subtable: bodyForm },
    {
        name: "Body: Function",
        range: _.range(201, 401),
        subtable: bodyFunctions,
    },
    {
        name: "Mind: Behaviours",
        range: _.range(401, 501),
        subtable: mindBehaviours,
    },
    {
        name: "Mind: Cognition",
        range: _.range(501, 601),
        subtable: mindCognition,
    },
    {
        name: "Psychic Powers",
        range: _.range(601, 701),
        subtable: psychicPowers,
    },
    {
        name: "Supernatural Attributes",
        range: _.range(701, 1001),
        subtable: supernaturalAttributes,
    },
]

const symptoms = [
    { range: [1], name: "Bone rot" },
    { range: [2], name: "Flesh rot" },
    { range: [3], name: "Inflamation" },
    { range: [4], name: "Neurological damage" },
    { range: [5], name: "Pulmonary infection" },
    { range: [6], name: "Sores and wounds" },
    { range: [7], name: "Tumours" },
    { range: [8], name: "Weakening" },
]

const vectors = [
    { range: [1], name: "Airborne" },
    { range: [2, 4], name: "Sexually transmitted" },
    { range: [5, 6], name: "Ingestion" },
    { range: [7, 8], name: "Touch" },
]

//randomly chooses from a table, taking an optional lower limit value other than 1
function pick(table, lowerLimit) {
    let selection = ""
    let lastRange = _.last(table)
    let firstRange = _.first(table)
    let ceiling = _.last(lastRange.range)
    let floor = _.first(firstRange.range)

    //option to set a flo than 1
    if (typeof lowerLimit !== "undefined") {
        floor = lowerLimit
    }

    let random = _.random(floor, ceiling)
    ...
    _.forEach(table, function (data) {
        let start = _.first(data.range)
        let end = _.last(data.range) + 1
        let bool = _.inRange(random, start, end)
...
function create() {
    let mutation = pick(mutationTableIndex)
    let animal = pick(creatures)
    return _.startCase(`${animal} with ${mutation}`)
}
